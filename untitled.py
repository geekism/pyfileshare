...
Changelog
   ...
   20100521 * Use %APPDATA% Windows environment variable -- fix by Maik.
   20091229 * IE layout fix by Carlos Eduardo Moreira dos Santos.
   20090202 * Fix for unicode filenames by xissy.
...
<!--
* {margin: 0; padding: 0;}
body {text-align: center; background-color: #000; font-family: sans-serif;
      color:#fefefe;}
